const CACHE='camutanga-v2-3-shell';
const SHELL=['./','./index.html','./background.css','./background.js','./fonts/gamefont.css','./icon/icon.png','./js/main.js','./js/plugins.js','./js/plugins/CamutangaLife.js','./js/plugins/CamutangaHero.js'];
