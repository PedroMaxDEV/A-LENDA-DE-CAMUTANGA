const CACHE = 'camutanga-v45-geografia-oficial';
const SHELL = [
  ...
  './js/plugins/CamutangaFreeRoam.js','./js/plugins/CamutangaCidadeViva.js','./js/plugins/CamutangaSocial35.js','./js/plugins/CamutangaRelaunch40.js','./js/plugins/CamutangaUX41.js','./js/plugins/CamutangaRelease42.js','./js/plugins/CamutangaRelease43.js','./js/plugins/CamutangaRelease44.js','./js/plugins/CamutangaOfficial45.js','./img/pictures/CamutangaUI/CamutangaMap43.png','./img/pictures/CamutangaUI/Bus43.png'
];
...
self.addEventListener('install', event => {
  event.waitUntil((async()=>{
    ...
    await Promise.all(SHELL.map(async url => {
      try {
        const r = await fetch(url + (url.includes('?') ? '&' : '?') + 'v=45', {cache:'no-store'});
